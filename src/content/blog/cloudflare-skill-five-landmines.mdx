...
<Moji emoji="スキル" />の<Moji emoji="ソース" />は[こちら](https://github.com/GeneralD/.config/tree/main/claude/skills/launch-site)に置いています。

![手元に並んだ5つの地雷](/images/cloudflare-skill-five-landmines/hero.png)
...
![headless Chromium がダッシュボードに弾かれる](/images/cloudflare-skill-five-landmines/headless-blocked.png)
...
![Git アカウントセレクターのサイレント失敗](/images/cloudflare-skill-five-landmines/git-selector.png)
