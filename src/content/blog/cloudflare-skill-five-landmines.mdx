...
![5つの罠を踏み越えるエンジニア — ヒーローイラスト](/images/cloudflare-skill-five-landmines/hero.png)
...
Cloudflare<Moji emoji="自身" />が、headless Chromium の<Moji emoji="ボット" /><Moji emoji="フィンガー" /><Moji emoji="プリント" />を<Moji emoji="弾き" />ました。<Moji emoji="自社" /><Moji emoji="ダッシュ" /><Moji emoji="ボード" />で<Moji emoji="自社" />の<Moji emoji="ボット" /><Moji emoji="検知" />が<Moji emoji="火" />を噴く——なかなか<Moji emoji="面白い" /><Moji emoji="構図" />です。

![headless Chromium が Cloudflare のセキュリティ検証で弾かれるシーン](/images/cloudflare-skill-five-landmines/headless-blocked.png)headless<Moji emoji="モード" />を<Moji emoji="諦め" />て `--headed` で<Moji emoji="起動" />しても、<Moji emoji="クッキー" />がなければ<Moji emoji="同じ" /><Moji emoji="画面" />で<Moji emoji="止まり" />ます。
...
![null アカウントが選ばれたドロップダウン — 困惑するエンジニアのイラスト](/images/cloudflare-skill-five-landmines/git-selector.png)
